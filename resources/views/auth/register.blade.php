    ...
    <div class="page page-center">
        <div class="container py-4 container-tight">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="name" id="name" placeholder="Masukkan Nama anda" autocomplete="off">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-2">
                            <label class="form-check" for="password_confirmation" :value="__('Confirm Password')">
            ...
            <div class="mt-3 text-center text-muted">
                Or <a href="{{ route('login') }}" tabindex="-1">Sign In</a>
            </div>
        </div>
    </div>
    <!-- Libs JS -->
