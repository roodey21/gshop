<x-app-layout>
    ...
    <div class="col-md-6">
        <form class="card" action="{{ route('admin.bank.update', $bank->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="name" value="{{ old('name', $bank->name) }}" class="form-control @error('name') is-invalid @enderror" aria-describedby="nameHelp"
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="account_name" value="{{ old('account_name', $bank->account_name) }}" class="form-control @error('account_name') is-invalid @enderror" aria-describedby="nameHelp"
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="account_number" value="{{ old('account_number', $bank->account_number) }}" class="form-control @error('account_number') is-invalid @enderror" aria-describedby="nameHelp"
                ...
                <div class="mb-3">
                    ...
                    <label class="form-check form-switch">
                        <input class="form-check-input @error('status') is-invalid @enderror" value="1" type="checkbox" {{ old('status', $bank->status) == 1 ? 'checked':'' }} name="status">
            ...
            <div class="card-footer text-end">
                <a href="{{ route('admin.bank.index') }}" class="btn btn-outline-dark">Kembali</a>
